...
mpirun --map-by :OVERSUBSCRIBE -np 1 ./test_prolong_nl_3d 32 32 32
check
run_verify

echo -n "3D 2x1x1 (65x33x33): "
mpirun --map-by :OVERSUBSCRIBE -np 2 ./test_prolong_nl_3d 64 32 32
check
run_verify

echo -n "3D 2x2x2 (33x33x33): "
mpirun --map-by :OVERSUBSCRIBE -np 8 ./test_prolong_nl_3d 32 32 32
check
run_verify

echo -n "3D 2x2x2 (63x63x63): "
mpirun --map-by :OVERSUBSCRIBE -np 8 ./test_prolong_nl_3d 62 62 62
check
run_verify

echo -n "3D 3x3x3 (33x33x33): "
mpirun --map-by :OVERSUBSCRIBE -np 27 ./test_prolong_nl_3d 32 32 32
check
run_verify
