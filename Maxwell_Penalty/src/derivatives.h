...
static inline double D1UP(const double *f, int64_t i, int64_t di, double h)
{
    const double ooh = 1.0 / (h);
    return (-f[i] + f[di + i]) * ooh;
}
static inline double D1DN(const double *f, int64_t i, int64_t di, double h)
{
    const double ooh = 1.0 / (h);
...
static inline double D2CEN(const double *f, int64_t i, int64_t di, double h)
{
    const double oo2h = 1.0 / (2 * h);
    return (-f[-di + i] + f[di + i]) * oo2h;
}
static inline double D2UP(const double *f, int64_t i, int64_t di, double h)
{
    const double oo2h = 1.0 / (2 * h);
    return (-3 * f[i] + 4 * f[i + di] - f[i + 2 * di]) * oo2h;
}
static inline double D2DN(const double *f, int64_t i, int64_t di, double h)
{
    const double oo2h = 1.0 / (2 * h);
...
#define D4CEN_HALF 2
static inline double D4CEN(const double *f, int64_t i, int64_t di, double h)
{
...
static inline double D6CEN(const double *f, int64_t i, int64_t di, double h)
{
...
static inline double D8CEN(const double *f, int64_t i, int64_t di, double h)
{
...
static inline double D2xy(const double *f, int64_t i, int64_t di, int64_t dj, double dx, double dy)
{
...
static inline double D2xx(const double *f, int64_t i, int64_t di, double dx)
{
...
static inline double D4xy(const double *f, int64_t i, int64_t di, int64_t dj, double dx, double dy)
{
    const double dxdy = dx * dy;
...
static inline double D4xx(const double *f, int64_t i, int64_t di, double dx)
{
    const double dx2 = dx * dx;
...
static inline double D6xy(const double *f, int64_t i, int64_t di, int64_t dj, double dx, double dy)
{
    const double dxdy = dx * dy;
...
static inline double D6xx(const double *f, int64_t i, int64_t di, double dx)
{
    const double dx2 = dx * dx;
...
static inline double D8xy(const double *f, int64_t i, int64_t di, int64_t dj, double dx, double dy)
{
    const double dxdy = dx * dy;
...
static inline double D8xx(const double *f, int64_t i, int64_t di, double dx)
{
    const double dx2 = dx * dx;
...
static inline double SBP42_L0(const double *f, int64_t i, int64_t dk, double h)
{
    const double ooh = 1.0 / h;
...
static inline double SBP42_L1(const double *f, int64_t i, int64_t dk, double h)
{
...
static inline double SBP42_L2(const double *f, int64_t i, int64_t dk, double h)
{
    const double ooh = 1.0 / h;
...
static inline double SBP42_L3(const double *f, int64_t i, int64_t dk, double h)
{
    const double ooh = 1.0 / h;
...
static inline double SBP42_RN(const double *f, int64_t i, int64_t dk, double h)
{
    const double ooh = 1.0 / h;
...
static inline double SBP42_RNm1(const double *f, int64_t i, int64_t dk, double h)
{
    const double oo2h = 1.0 / (2.0 * h);
    return (-f[i - dk] + f[i + dk]) * oo2h;
}
...
static inline double SBP42_RNm2(const double *f, int64_t i, int64_t dk, double h)
{
    const double ooh = 1.0 / h;
    return ( 4.0/43.0 * f[i - 2 * dk]
          - 59.0/86.0 * f[i -     dk]
...
static inline double SBP42_RNm3(const double *f, int64_t i, int64_t dk, double h)
{
    const double ooh = 1.0 / h;
...
static inline double DISSIP_any_1(const double *f, int64_t i, int64_t di)
{
    return (-2 * f[i] + f[-di + i] + f[di + i]) / 4;
}

/* Third order dissipation */
static inline double DISSIP_any_3(const double *f, int64_t i, int64_t di)
{
...
static inline double DISSIP_any_5(const double *f, int64_t i, int64_t di)
{
...
static inline double DISSIP_any_7(const double *f, int64_t i, int64_t di)
{
...
static inline double DISSIP_any_9(const double *f, int64_t i, int64_t di)
{
