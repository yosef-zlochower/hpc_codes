                                        ...
                                        const char *fname)
{
    ...
    /* [grid] */
    param->nx = (int)parameters::get_positive_integer_value("grid", "nx", tbl);
    param->ny = (int)parameters::get_positive_integer_value("grid", "ny", tbl);
    param->nz = (int)parameters::get_positive_integer_value("grid", "nz", tbl);
    ...
    /* [solver] */
    param->ghost_size      = (int)parameters::get_positive_integer_value("solver", "ghost_size", tbl);
    param->cfl_factor      = parameters::get_positive_real_value("solver", "cfl_factor", tbl);
    param->max_iterations  = (int)parameters::get_positive_integer_value("solver", "max_iterations", tbl);
    param->output_every    = (int)parameters::get_positive_integer_value("solver", "output_every", tbl);
    param->checkpoint_every = (int)parameters::get_nonnegative_integer_value("solver", "checkpoint_every", tbl);
    param->max_checkpoints  = (int)parameters::get_positive_integer_value("solver", "max_checkpoints", tbl);
    param->output_2d_z_plane = (int)parameters::get_integer_value_or_default("solver", "output_2d_z_plane", tbl, -1);
    ...
    param->te_waveguide_mode.l = (int)parameters::get_positive_integer_value("source.te_waveguide_mode", "l", tbl);
    param->te_waveguide_mode.m = (int)parameters::get_positive_integer_value("source.te_waveguide_mode", "m", tbl);
    param->te_waveguide_mode.n = (int)parameters::get_positive_integer_value("source.te_waveguide_mode", "n", tbl);
