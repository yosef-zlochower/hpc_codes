...
The function \texttt{gauss\_seidel\_3d} (\texttt{gauss\_seidel.c:86}) implements
...
\texttt{calc\_defect\_3d} (\texttt{gauss\_seidel.c:196}) evaluates
...
\texttt{ngfs\_3d\_create\_hierarchy} (\texttt{multigrid.c:228}) builds
...
\texttt{vcycle\_3d} (\texttt{multigrid.c:711}) implements
\Cref{alg:vcycle}.
...
\texttt{driver\_multigrid.c} (lines 125--139):
\begin{lstlisting}
...
The function \texttt{apply\_bc\_3d} (\texttt{gauss\_seidel.c:21})
